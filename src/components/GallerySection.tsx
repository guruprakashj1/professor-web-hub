...
import { Calendar, MapPin, Camera, Video, Tag } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {gallery.length === 0 ? (
          <div className="text-center text-gray-700 py-16">
            <div className="text-xl mb-4 font-light">No media available</div>
            <p className="font-light">Event photos and videos will be displayed here.</p>
          </div>
        ) : (
              ...
              <Card key={item.id} className="group cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-xl border border-gray-200 hover:border-black bg-white overflow-hidden">
                <div className="aspect-video relative overflow-hidden">
                  ...
                  <div className="absolute top-3 right-3 flex gap-2">
                    <span className="px-2 py-1 bg-black/80 text-white text-xs rounded font-light flex items-center gap-1">
